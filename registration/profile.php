        ...
        <div class="header_content_2">
            <nav class="navig">                
                ...
                <div class="container_links">
                    <a href="#"><img class="icon icon_user" width="30px" src="../icons/user.png" alt="account"></a>
                    <?php 
                        if($_SESSION['user']){
                            echo '<div class="extra_user_data hide">
                                    <p class="greeting">Welcome '.$_SESSION['user']['login'].'</p>
                                    <a href="profile.php" class="extra_user_data_links profile">profile</a>
                                    <a href="vendor/logout.php" class="extra_user_data_links logout">log out</a>
                                </div>';
                        }
                    ?>
                    <a href="#"><img class="icon user_icon" width="30px" src="../icons/favorite.png" alt="favorite"></a>
        ...
        <div class="main_container">
            <div class="left_content">
                <div class="user_information">
                    <h2 class="user_header">Welcome <?= $_SESSION['user']['login'] ?></h2>
                    <p class="user_data user_email">Email: <?= $_SESSION['user']['email']?></p>
                    <p class="user_data user_phone">Phone number: <?= $_SESSION['user']['tel']?></p>
                    <p class="user_data user_address">Address:</p>
                    <a href="#" class="user_data user_orders">Orders:</a>
                </div>
            </div>
            <div class="right_content">
                <a class="link_prom" href="#">
                    <img class="promo_img" src="../image/watch_all_promotions_man.webp" alt="watch promotions">
                    watch promotions
                </a>
            </div>
        </div>
