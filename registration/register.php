    ...
    <section class="main_section">
        <div class="main_container">
            <form action="vendor/signup.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="form_control">
                    <input type="password" name="password_confirm" required class="form_inp pass" autocomplete="disabled">
                    <span class="extra_input_text">password repeat</span>
                </div>
                <div class="form_control">
                    <input type="email" name="email" required class="form_inp email" autocomplete="disabled">
                    <span class="extra_input_text">email</span>
                    <div id="emailHelp" class="form-text">We'll never share your email with anyone else.</div>
                </div>
                <div class="form_control">
                    <input type="tel" name="phone_num" required class="form_inp tel" autocomplete="disabled">
                    <span class="extra_input_text">phone number</span>
                </div>
                <button class="btn_submit" type="submit">submit</button>
                <p class="smpl_text">You already have an account? - <a class="sign_up_href" href="index.php">Log in!</a></p>
                <?php 
                    if($_SESSION['message']){
